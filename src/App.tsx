...
import {Box, CssBaseline, Paper, Popper, ThemeProvider, Typography} from "@mui/material";
...
export const App: React.FC = (props: Record<string, any>) => {
    ...
    return (
        <HashRouter>
            <ThemeProvider theme={getThemeDefinition(global.store.get("application.colorTheme"))}>
