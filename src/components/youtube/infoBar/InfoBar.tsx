    ...
    return (
        ...
        >
            ...
            <Stack direction="row" spacing={1} alignItems="center">
                ...
                <Tooltip
                    title={t("totalPlaylistsCount", {num: size(playlists)})}
                    arrow
                    enterDelay={500}
                    leaveDelay={100}
                    enterNextDelay={500}
                ...
                <Tooltip
                    title={t("downloadedPlaylistsCount", {num: getGrabbedPlaylists()})}
                    arrow
                    enterDelay={500}
                    leaveDelay={100}
                    enterNextDelay={500}
                ...
                <Tooltip
                    title={t("totalTracksCount", {num: size(tracks)})}
                    arrow
                    enterDelay={500}
                    leaveDelay={100}
                    enterNextDelay={500}
                ...
                <Tooltip
                    title={t("downloadedTracksCount", {num: getGrabbedTracks()})}
                    arrow
                    enterDelay={500}
                    leaveDelay={100}
                    enterNextDelay={500}
